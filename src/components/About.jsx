    ...
    >
      <motion.div initial={{x:-100,opacity:0} } whileInView={{x:0,opacity:1,transition:{ease:'easeIn', type:'spring',duration:2}}} className="flex flex-col sm:gap-3 md:ml-[3rem]  sm:w-[40%] sm:pt-[5%] sm:pb-[2rem] max-sm:pb-[2rem]">
        <div>
          ...
          <div className=" ">
            <p style={{fontFamily: `'Segoe UI', sans-serif`}} className="tracking-widest text-justify text-[#705704] md:text-[1.2rem]  max-sm:text-[1rem] leading-[1.6rem] max-sm:py-[1rem] max-sm:px-[2rem]   sm:text-[1rem] sm:pl-[3rem]">
             <i>
