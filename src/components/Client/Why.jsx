            ...
            <CardActionArea className="p-2">
              ...
              <CardContent>
                <Typography gutterBottom variant="h5" component="div">
                  <p
                    style={{ fontFamily: ' "Rakkas", serif', fontWeight: 700 }}
                    className="text-3xl text-[#612f20]"
                  >
                    Customized Events
                  </p>
                </Typography>
                <Typography variant="body1" color="text.secondary">
                  <p className=" md:text-[1rem] text-[#684f2a] tracking-wide  sm:text-[0.88rem]">
        ...
        <div className="flex flex-col gap-4 md:ml-4 max-md:p-[1rem] ">
          ...
          >
            ...
            >
              ...
              <p className=" md:text-[1rem] h-[100%] text-[#684f2a] md:tracking-wide  sm:text-[0.88rem]">
                {" "}
