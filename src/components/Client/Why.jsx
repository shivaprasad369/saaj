      ...
      <div className="flex flex-row max-md:flex-col gap-10">
        ...
        <div className="flex flex-col gap-4 ml-4 ">
                  ...
                  >
                    ...
                    <div className="flex w-3/4 flex-col justify-center p-6">
                      <h3 className="mb-2 text-xl font-medium text-gray-900">
                      Special Decor
                      </h3>
                      <p className="text-gray-700 max-md:text-sm">From unique floral arrangements to personalized themes, our
