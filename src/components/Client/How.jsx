...
export default function How() {
  return (
    <div id="why" className=" w-full h-full relative overflow-hidden flex flex-col flex-wrap items-center justify-center mt-[1rem] bg-gray-50">
      ...
      <div className=" sm:w-[90%]">
        ...
        >
          <div className="p-6 relative md:w-2/3 overflow-hidden">
            ...
            <p className="text-[#7a4d189f] tracking-[0.2rem] md:text-xl">
              {" "}
              <span className="absolute md:left-[2rem] md:bottom-[3.5rem] max-md:top-[-2.5rem]"><i className=" h-[10rem]  width-29"><h1 className="text-[10rem] text-[#c4b48791] font-extrabold">1.</h1></i></span> 
        ...
        >
          ...
          <div className="p-6 relative md:w-2/3">
            ...
            <p className="text-[#7a4d189f] tracking-[0.2rem] md:text-xl">
              {" "}
              <span className="absolute md:left-[3rem] md:bottom-[3.5rem] max-md:top-0 w-9  "><i className=" h-[10rem]  width-29"><h1 className="text-[10rem]  text-[#cabe9b91] font-extrabold">2.</h1></i></span> 
        ...
        >
          <div className="relative p-6 md:w-2/3">
            ...
            <p className="text-[#7a4d189f] tracking-[0.2rem] md:text-xl">
              {" "}
              <span className="absolute  w-9 md:left-[3rem] md:bottom-[3.5rem] max-md:top-0 md:bottom-[5rem]"><i className=" h-[10rem]  width-29"><h1 className="text-[10rem] text-[#dac89891] font-extrabold">3.</h1></i></span> 
