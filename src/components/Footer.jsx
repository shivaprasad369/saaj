      ...
      <iframe className="max-md:w-[100%] "
        ...
        />
          ...
          <div className="flex flex-row mt-7">
            <p className="flex gap-3 text-xl flex-col"><span className="pr-3 ">Follow Us on</span><span className="flex gap-4"><FaFacebook /> <LuInstagram /> <IoLogoTwitter /> <FaLinkedinIn /></span></p>
          </div>
        </div>
      </div>
