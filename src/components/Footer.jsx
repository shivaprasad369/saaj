...
export default function Footer() {
  return (
    <div id="contact" className="bg-[#5F3615] justify-center items-center text-center  text-white flex-wrap mt-8 max-[730px]:py-[1rem] max-[672px]:gap-[2rem]">
      
      <div className=" relative md:pt-[5rem] max-md:ml-[40%] max-md:pb-[1rem] max-md:mt-[2rem]">
          <img src={logo} alt="logo" className="w-[10rem] max-md:top-[1rem] md:absolute top-6 left-[46%]"/>
        </div>
      <div style={{fontFamily: `"Mate SC", serif`}} className="flex flex-1 justify-around max-md:justify-center items-center max-md:flex-col px-8">
        <div className="text-left gap-4 ">
          <h1 className="text-center font-bold text-3xl max-md:pt-[1rem] max-md:text-4xl max-md:pb-4 ">Get In Touch</h1>
          <ul className="flex flex-col max-md:text-center">
            <li className="flex px-2 my-2 tracking-wider">
              <FaLocationDot  className="mr-2 text-xl mt-3"/> <span className="text-md">SF 228, 25 floor, Vidya Nagar,<br/>
Hubballi, Karnataka 580021</span>
      ...
      <iframe className="max-md:w-[100%] "
        ...
        <div className="text-center  gap-3 flex flex-col p-3 md:mt-[4rem] ">
        ...
        <input type="email" className="border-b-2 focus:border-0 border-white bg-[#5F3615] text-white  h-[2rem] p-3 my-4" placeholder="Enter a email address" />
          ...
          <div className="flex flex-row mt-7">
            <p className="flex ml-[2rem] gap-3 text-xl flex-col pb-4"><span className="pr-3 ">Follow Us on</span><span className="flex gap-4"><FaFacebook /> <LuInstagram /> <IoLogoTwitter /> <FaLinkedinIn /></span></p>
          </div>
        </div>
      </div>
      <div className="  ">
        <div style={{fontFamily: `"Mate SC", serif`}} className="text-md tracking-widest flex flex-wrap md:ml-[30%] max-md:ml-[15%]  max-[378px]:hidden   gap-2 text-center">
