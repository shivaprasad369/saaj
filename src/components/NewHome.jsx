...
//   };
  ...
  return (
    ...
    >
        <Navbar />
        <img src={img} alt="" className="absolute sm:top-3 max-sm:top-2 left-3 sm:w-[13rem] max-sm:w-[8rem] "/>
      <div  className="bg-[#ddd3d300] bg-cover md:h-[100vh]  overflow-hidden object-contain w-[100%] h-[25rem] ">
       
      
         <video className="absolute w-full h-[100%]  object-cover  top-0 left-0 z-[-1] overflow-hidden" poster={bg} autoPlay muted loop >
