    ...
    >
      <div className="flex flex-1 justify-around w-full max-[952px]:flex-col max-[952px]:mx-[2.5rem] ">
        ...
        >
          ...
          <img src={img} alt="" className="w-[2rem] max-[952px]:hidden h-[20rem]" />
        </div>
        <div className="flex flex-col border-0 w-[12rem] mt-[2rem]">
          <h1 style={{fontFamily:'FedraSansStd-A-medium',fontWeight:600,fontSize:'20px' ,lineHeight: 1.2}} className="text-[#cd6727] mb-[0.8rem]  font-">Subscribe</h1>
          <div>
            <div className="max-[952px]:flex max-[450px]:flex-col max-[952px]:gap-3  w-[25rem]">

            <img src={yt} alt="" className="w-[9rem] h-[5rem] max-[952px]:h-[7rem] " />
            <p className="p max-[952px]:w-[12rem] w-[10rem] max-[952px]:h-[7rem]">
              Join 1.2 Million people from around the world, get wisdom articles
              delivered in the mailbox for free.
            </p>
            </div>
        ...
        <div className="b-2 w-[13rem] gap-3 mt-[2rem] pb-4">
          <h1 style={{fontWeight:600}} className="contact ">Contact us</h1>
          <div className="text-[16px]">
            <p className="mb-[2rem]  gap-3">
            <svg xmlns="http://www.w3.org/2000/svg" className="float-start " width={15} viewBox="0 0 384 512"><path fill="#ffffff" d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg>
                 <span className="pr-2"></span>SF 228, 25 floor, Vidya Nagar,
Hubballi, Karnataka 580021
            </p >

            <p className="mb-[2rem] "><svg xmlns="http://www.w3.org/2000/svg" className={'w-5 float-start'} w={10} viewBox="0 0 512 512"><path fill="#ffffff" d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z"/></svg>
            <span className="pr-2"/>+19 797540000,<br /> +19 8815566156</p>
            <p><svg xmlns="http://www.w3.org/2000/svg" className="w-5 float-start" viewBox="0 0 512 512"><path fill="#ffffff" d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg> <span className="pr-2"/>
            info@saajevents.com.</p> 
          </div>
        </div>
...
<path fill="#ffffff" d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"/>
      ...
      <div className="flex items-center py-[2rem] ml-[10%] max-[950px]:mr-[5%] text-[#676055] cursor-pointer max-[500]:flex-col" >© 1999 - 2023 Unitechno software development pvt ltd. All Rights Reserved.

<span className="text-white px-2"> |</span> Terms & Conditions<span className="text-white px-2"> |</span> Privacy Policy</div>
    </div>
  );
}
