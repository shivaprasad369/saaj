    ...
    <div className=" md:flex flex-col  gap-5 py-[4rem] md:pl-[5rem]">
      <div className="flex flex-col gap-4 max-md:justify-center max-md:items-center">
        <div className="flex flex-col flex-wrap px-4 gap-2 mt-[2rem] md:pt-[2rem]">
          ...
          <div style={{fontFamily: "'Segoe UI', sans-serif",letterSpacing:' 0.1em'}} className="text-[1.2rem] tracking-wider text-[#462d19]  ">
        ...
        <div className="md:flex max-[910px]:flex-col w-full  justify-between items-center md:py-5 md:gap-14  ">
          <div className="flex flex-col md:w-5/6 gap-3 max-md:pl-[3rem]">
            <form style={{fontFamily: "'Segoe UI', sans-serif",letterSpacing:' 0.1em'}} className="flex flex-col mr-[rem] max-md:mr-[4rem] gap-14 pb-5">
              <input
                type="text"
                name="name"
                placeholder="Name"
          ...
          <div className="bg-[#9e763b] overflow-hidden font-semibold text-white  md:w-screen pt-[2rem] pb-[3.3rem] px-[3rem] flex flex-col rounded-sm gap-14">
            <div className="md:flex  max-md:flex-col">
              <div className="flex flex-col rounded-sm gap-14">
                <h1  style={{ fontFamily:`"Tinos", serif` }} className="text-3xl tracking-widest  ">Info</h1>
                <div className="flex gap-9 tracking-widest   " style={{fontFamily: "'Segoe UI', sans-serif",letterSpacing:' 0.1em'}}>
                  <svg
                  ...
                  <p className="" style={{fontFamily: "'Segoe UI', sans-serif",letterSpacing:' 0.1em'}}>info@sajjevents.com.</p>
                </div>
                <div className="flex gap-9 tracking-widest">
                  ...
                  <div style={{fontFamily: "'Segoe UI', sans-serif",letterSpacing:' 0.1em'}}>
                    <p>+19 797540000</p>
                    <p>+19 8815566156</p>
                  </div>
                </div>
